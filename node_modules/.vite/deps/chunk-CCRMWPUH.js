...
function createSlot3(ownerName) {
  ...
  const Slot22 = React10.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime7.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React10.isValidElement(newElement) ? React10.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var PopperAnchor = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime12.jsx)(Primitive4.div, { ...anchorProps, ref: composedRefs });
  }
);
...
function isSlottable5(child) {
  return React16.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
var Portal = React18.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime15.jsx)(Primitive5.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
//# sourceMappingURL=chunk-CCRMWPUH.js.map
